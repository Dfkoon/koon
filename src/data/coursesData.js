export const coursesData = {
    ...
    ai_ds_mandatory: [
        {
            ...
            icon: '🗣️',
            files: { pdf: 'https://drive.google.com/drive/folders/1-YoCdvVPfLS0YkK8IhOarqpU22F1nKY9?usp=drive_link' }
        },
        {
            ...
            icon: '📈',
            files: { pdf: 'https://drive.google.com/drive/folders/1gRGLEP0A033TDZm6WmrDHpDae2XK3xfT?usp=drive_link' }
        },
        {
            id: 'ds_bigdata',
            ...
            icon: '📊',
            files: { pdf: 'https://drive.google.com/drive/folders/1zVd6H6n4_EPOMIvLOOtb6stkRk6mJi4m?usp=drive_link' }
        },
        {
            id: 'ds_cv',
            ...
            icon: '👁️',
            files: { pdf: 'https://drive.google.com/drive/folders/1mMkGcqKEuNwb1V5KyByAHaxqNiY6HJW4?usp=drive_link' }
        },
        {
            id: 'ds_ml_lab',
            name: 'لاب تعلم الآلة (د. سارة)',
            nameEn: 'Machine Learning Lab (Dr. Sarah)',
            icon: '💻',
            files: { link: 'https://drive.google.com/drive/folders/1P5kb4K0RzIS29p2W65c3ztox0GJi_ZHl?usp=drive_link' }
        },
        {
            id: 'ds_iot',
            ...
            icon: '🌐',
            files: { pdf: 'https://drive.google.com/drive/folders/1d8piAhSG3YxV6AzB-E0TMwXeaoCXtotY?usp=drive_link' }
        },
        {
            id: 'ds_pattern',
            ...
            icon: '🧩',
            files: { pdf: 'https://drive.google.com/drive/folders/1anTq3RMi-w6QbNTwBFRbgX-6jLIJ7vtw?usp=drive_link' }
        }
    ],
    ai_ds_elective: [
        { id: 'ds_cloud', name: 'حوسبة سحابية', nameEn: 'Cloud Computing', icon: 'gf', files: {} },
        { id: 'ds_ir', name: 'نظم استرجاع بيانات', nameEn: 'Information Retrieval Systems', icon: 'gf', files: {} },
        { id: 'ds_dw', name: 'مخازن بيانات', nameEn: 'Data Warehouses', icon: 'gf', files: {} },
        { id: 'ds_mining', name: 'تنقيب بيانات', nameEn: 'Data Mining', icon: 'gf', files: {} },
    ...
    it_cs_mandatory: [
        { id: 'cs_ai', name: 'الذكاء الاصطناعي', nameEn: 'Artificial Intelligence', icon: '🤖', files: { link: 'https://drive.google.com/drive/folders/1wudV-rozSKiBieU7DkUhd2jmba3ahupX' } },
        { id: 'cs_theory', name: 'النظريه الإحتسابيه والأتمته', nameEn: 'Theory of Computation and Automata', icon: '♾️', files: { link: 'https://drive.google.com/drive/folders/1iTErthqU45rFo_URpH1cr2zD-0apEJVK' } },
        { id: 'cs_sec', name: 'أمن الحاسوب والشبكات', nameEn: 'Computer and network security', icon: '🛡️', files: { link: 'https://drive.google.com/drive/folders/1w8KDmIU-TQeJ07peFosusIS4_g8mr-GC' } },
        { id: 'cs_systems', name: 'تحليل وتصميم النظم', nameEn: 'System design and analysis', icon: '📊', files: { link: 'https://drive.google.com/drive/folders/1Mm3rnKDmmJHPqTdobUmrRI6i9hWbqwqW' } },
        { id: 'cs_compilers', name: 'تصميم المترجمات ولغات البرمجة', nameEn: 'Design compilers and programming languages', icon: '⚙️', files: { link: 'https://drive.google.com/drive/folders/1c2p-1NWiA69I-gX0x2NMtOLr4hGbjPpq' } },
        { id: 'cs_embedded', name: 'تصميم وتنظيم الأنظمة المدمجة', nameEn: 'Embedded Systems Design and Organization', icon: '📟', files: { link: 'https://drive.google.com/drive/folders/1Sjqe4dOfIgpDziB7nqZIXpRgUtFr6y1u' } },
        { id: 'cs_wireless', name: 'شبكات الحاسوب اللاسلكيه', nameEn: 'wireless computer networks', icon: '📡', files: { link: 'https://drive.google.com/drive/folders/1nySvGgtgKJU15Xi3OiUdrzAmb5J2ln1Y' } },
        { id: 'cs_arch_bh', name: 'معمارية الحاسوب (د.باسم الحديدي)', nameEn: 'Computer Architecture (Dr. Basem)', icon: '🏛️', files: { link: 'https://drive.google.com/drive/folders/1sBoO2YchwUGgWN1Fsld2cU8kv87VvykT' } },
        { id: 'cs_arch', name: 'معمارية الحاسوب', nameEn: 'Computer Architecture', icon: '🏛️', files: { link: 'https://drive.google.com/drive/folders/1VrcMOIyUcVofJ9yCcWId0kCpKIfYwvC_' } },
        { id: 'cs_modern_se', name: 'هندسة برمجيات حديثة', nameEn: 'Modern software engineering', icon: '🏗️', files: { link: 'https://drive.google.com/drive/folders/1DMMhvTHOUYdKIZFsTqTOEnyPSTU_pe1N' } }
    ],

    // Computer Science Elective Specialization
    it_cs_elective: [
        { id: 'cs_cloud', name: 'الحوسبه السحابيه', nameEn: 'Cloud Computing (Huawei)', icon: '☁️', files: { link: 'https://drive.google.com/drive/folders/1P5HzAb7P4_ro9rwoICNFi5vL-Duo4LGj' } },
        { id: 'cs_adv_ai', name: 'الذكاء الاصطناعي المتقدم وتعلم الاله', nameEn: 'Advanced AI & ML', icon: '🤖', files: { link: 'https://drive.google.com/drive/folders/1AG3hzxRanJ7Iqrpz4MygOPtJMSOwXfkK' } },
        { id: 'cs_multimedia', name: 'الوسائط المتعدده', nameEn: 'Multimedia', icon: '🎨', files: { link: 'https://drive.google.com/drive/folders/1kdjpt25o1zxsMpvVg_PTWd6gJCb9vJUK' } },
        { id: 'cs_db2', name: 'تصميم وإدارة قواعد البيانات ٢', nameEn: 'DB Design & Management 2', icon: '🗄️', files: { link: 'https://drive.google.com/drive/folders/165_iCrEFgwbNM4TEhdjV2PO71qsgze6F' } },
        { id: 'cs_ml', name: 'تعلم الاله', nameEn: 'Machine learning', icon: '🤖', files: { link: 'https://drive.google.com/drive/folders/1hJ4ndlsHRfemvM6hqJGeGWcGbECpPnjY' } },
        { id: 'cs_image', name: 'معالجه الصور والرؤيه الرقميه', nameEn: 'Image processing and digital vision', icon: '👁️', files: { link: 'https://drive.google.com/drive/folders/12oOAaBiLi8qphebpgIpdbf98JVfJ_WMU' } },
        { id: 'cs_topics', name: 'مواضيع في علم الحاسوب', nameEn: 'Topics in computer science', icon: '📚', files: { link: 'https://drive.google.com/drive/folders/1ufSoTv7-nwJ3Lx7RPFYRMGIJFnH_pDRG' } },
